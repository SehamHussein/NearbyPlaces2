...
public class NearAdapter extends ArrayAdapter<NearModel> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        types.setText((CharSequence) nearModel.getTypes());
        TextView name = (TextView) convertView.findViewById(R.id.textView11);
        name.setText(nearModel.getName());
        TextView open = (TextView) convertView.findViewById(R.id.textView12);
        open.setText("opening Hours : " + nearModel.getOpeningHours());
//        String type="[ ";
